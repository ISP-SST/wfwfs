...
macro( appendPaths )
    ...
    if( DEFINED ${EXT_NAME}_FOUND )
        append_libs_unique( WFWFS_CURRENT_LIBRARIES "${${EXT_NAME}_LIBRARIES}" )
        append_paths_unique( WFWFS_CURRENT_INCLUDES ${${EXT_NAME}_INCLUDE_DIR} )
        append_paths_unique( WFWFS_CURRENT_LIBDIRS ${${EXT_NAME}_LIB_DIRS} )
    endif()
endmacro()
