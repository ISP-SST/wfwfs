...
execute_process( COMMAND "date" "+%Y-%m-%d %H:%M:%S" OUTPUT_VARIABLE REVISION_BUILD_TIME OUTPUT_STRIP_TRAILING_WHITESPACE )

string( REGEX MATCHALL "[0-9.]+(-[0-9]+)-g" _VERSION_STR "${REVISION_ID}" )
...
list( APPEND _CMAKE_ARGS -D${REVNAME}_COMMIT_TIME:STRING=${REVISION_COMMIT_TIME} )
list( APPEND _CMAKE_ARGS -D${REVNAME}_BUILD_TIME:STRING=${REVISION_BUILD_TIME} )
list( APPEND _CMAKE_ARGS -D${REVNAME}_COMMIT_INFO:STRING=${REVISION_DESCRIPTION} )
